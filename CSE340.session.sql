CREATE TYPE public.account_type AS ENUM ('clients', 'admin', 'employee');
ALTER TYPE public.account_type OWNER TO mulubahzumu_k_sipor;
CREATE TABLE IF NOT EXISTS classification(
    classification_id INT GENERATED BY DEFAULT AS IDENTITY,
    classification_name CHARACTER VARYING,
    CONSTRAINT classification_pkey PRIMARY KEY(classification_id)
);
CREATE SCHEMA IF NOT EXISTS public AUTHORIZATION mulubahzumu_k_sipor;
COMMENT ON SCHEMA public IS 'standard public schema';
GRANT USAGE ON SCHEMA public TO PUBLIC;
GRANT ALL ON SCHEMA public TO mulubahzumu_k_sipor;
...
CREATE TABLE IF NOT EXISTS classification(
    classification_id GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS inventory(
    ...
    CONSTRAINT inventory_pkey FOREIGN KEY(classification_id) REFERENCES classification(id),
...
CREATE TABLE IF NOT EXISTS account(
    ...
    account_type account_type NOT NULL DEFAULT 'clients',
