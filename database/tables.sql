CREATE SCHEMA IF NOT EXISTS public AUTHORIZATION cse340_1_zqdm_user;
COMMENT ON SCHEMA public IS 'standard public schema';
GRANT USAGE ON SCHEMA public TO PUBLIC;
GRANT ALL ON SCHEMA public TO cse340_1_zqdm_user;

DROP TYPE IF EXISTS account_type CASCADE;
CREATE TYPE account_type AS ENUM ('admin', 'clients');
...
CREATE TABLE IF NOT EXISTS inventory(
    ...
    CONSTRAINT inventory_fkey_classification FOREIGN KEY(classification_id) REFERENCES classification(classification_id),
